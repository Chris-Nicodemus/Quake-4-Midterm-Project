...
//changed walk speed from 80 to 240 (changed to sprint)
idCVar pm_walkspeed(				"pm_walkspeed",				"240",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT | CVAR_NORESET, "speed the player can move while walking" );
// RAVEN END
